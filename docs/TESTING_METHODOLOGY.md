...
This document describes the methods used. For results, see [capacity-validation-summary.md](https://github.com/fmonsalvebravo-dev/outputlayer/blob/main/docs/CAPACITY_VALIDATION_SUMMARY.md). For a developer-oriented interpretation, see [validation-results-overview.md](https://github.com/fmonsalvebravo-dev/outputlayer/blob/main/docs/VALIDATION_RESULTS_OVERVIEW.md).
