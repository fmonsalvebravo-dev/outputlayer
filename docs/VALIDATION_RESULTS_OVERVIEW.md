...
For detailed numbers, see [docs/CAPACITY_VALIDATION_SUMMARY.md](https://github.com/fmonsalvebravo-dev/outputlayer/blob/main/docs/CAPACITY_VALIDATION_SUMMARY.md). For testing methods, see [docs/TESTING_METHODOLOGY.md](https://github.com/fmonsalvebravo-dev/outputlayer/blob/main/docs/TESTING_METHODOLOGY.md).
